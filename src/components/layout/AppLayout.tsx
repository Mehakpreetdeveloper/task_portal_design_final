  ...
  <SidebarProvider>
    <div className="min-h-screen flex w-full">
      ...
      <div className="flex-1 flex flex-col">
        {/* Fixed Header */}
        <header className="flex items-center justify-between border-b bg-blue-color p-[0.6rem] sticky top-0 z-10">
            ...
            <Popover>
              <PopoverTrigger asChild>
                <Button variant="ghost" size="icon" className="relative text-white-color hover:bg-white-color/10">
                  ...
                  <span className="absolute -top-[0.25px] left-5 -right-1 h-4 w-4 bg-primary-color text-white-color text-xs rounded-full flex items-center justify-center">
                    3
                  </span>
                </Button>
              </PopoverTrigger>
        ...
        {/* Scrollable Main */}
        <main className="flex-1 p-6 bg-grey-color overflow-y-auto">
          {children}
        </main>
      </div>
    </div>
